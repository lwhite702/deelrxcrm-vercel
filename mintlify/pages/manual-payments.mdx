...
_Note: Third-party services may charge their own fees (e.g., Cash App business fees, bank wire fees)_
...
### Transparent Fee Structure _(When Available)_
...
<Note>
  Card processing fees only apply to credit/debit card transactions. Manual
  payment methods will always remain free of platform fees.
</Note>
...
_This guide will be updated as new payment features become available. Check back regularly for the latest information._
