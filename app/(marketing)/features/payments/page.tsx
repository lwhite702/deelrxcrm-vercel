...
import { CheckCircle, Clock, CreditCard, DollarSign, FileText, Shield, Smartphone, Upload, Users } from "lucide-react";
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-24 px-6 mx-auto max-w-7xl lg:px-8">
        <div className="text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Handle payments your way—manual reconciliation now, card processing coming soon. 
            Track every transaction with precision and keep your cash flow transparent.
          </p>
        </div>
      </section>
          ...
          <Card className="border-primary/20 shadow-lg shadow-primary/10">
            <CardHeader>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <CardTitle className="text-2xl text-primary">Manual Reconciliation</CardTitle>
                  <Badge variant="default" className="mt-1">Available Now</Badge>
                </div>
              </div>
              <CardDescription className="text-base">
                Track and reconcile all your payment methods with detailed records and notes.
              </CardDescription>
            </CardHeader>
          ...
          <Card className="border-secondary/20 shadow-lg shadow-secondary/10 relative overflow-hidden">
            <CardHeader>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <CardTitle className="text-2xl text-secondary">Card Processing</CardTitle>
                  <Badge variant="secondary" className="mt-1">Coming Soon</Badge>
                </div>
              </div>
              <CardDescription className="text-base">
                Built-in credit and debit card processing with competitive rates and fast payouts.
              </CardDescription>
            </CardHeader>
      ...
      <section className="py-16 px-6 mx-auto max-w-7xl lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">Why DeelRx Payment Processing</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Built for businesses that need flexibility, security, and transparency in every transaction.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="text-center">
            ...
            <CardContent>
              <CardDescription>
                All payment data encrypted with enterprise-grade security. Your customers' information stays protected.
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="text-center">
            ...
            <CardContent>
              <CardDescription>
                No hidden fees, no monthly minimums. You only pay when you process, and every fee is clearly disclosed.
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="text-center">
            ...
            <CardContent>
              <CardDescription>
                PCI DSS compliant processing ensures your business meets all regulatory requirements automatically.
              </CardDescription>
            </CardContent>
          </Card>
        </div>
      ...
      <section className="py-24 px-6 mx-auto max-w-4xl lg:px-8 text-center">
        ...
        <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
          Start with manual reconciliation today, then upgrade to card processing when it launches.
        </p>
