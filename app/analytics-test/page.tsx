      ...
      <div className="container mx-auto px-4">
        <header className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            This page demonstrates the PostHog analytics integration for DeelRx CRM. 
            Use the buttons below to test event tracking, user identification, and feature flags.
          </p>
        </header>
        ...
        <footer className="mt-12 text-center">
          <div className="bg-white rounded-lg shadow-lg p-6 max-w-2xl mx-auto">
            ...
            <p className="text-gray-500 mt-4 text-sm">
              Check the browser console for tracking logs and visit your PostHog dashboard to see real-time events.
            </p>
          </div>
        </footer>
      </div>
